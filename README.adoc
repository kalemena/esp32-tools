...
ifdef::env-github[]
image:https://img.shields.io/travis/kalemena/esp32-tools/master.svg[Travis build status, link=https://travis-ci.org/kalemena/esp32-tools]
image:https://images.microbadger.com/badges/version/kalemena/esp32tools.svg[Docker Version, link=https://microbadger.com/images/kalemena/esp32tools]
image:https://images.microbadger.com/badges/image/kalemena/esp32tools.svg[Docker Hub, link=https://hub.docker.com/r/kalemena/esp32tools/tags]
endif::[]
